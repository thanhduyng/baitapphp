      ...
      <div class="form-group">
                ...
                <div class="radio">
                    <label class="checkbox-inline">
                        <input type="radio"  name="trangthai" value="{{$license->trangthai}}" id="trangthai1">Đã dùng</label>
                    <label class="checkbox-inline">
                        <input type="radio"  name="trangthai" checked="checked"value="{{$license->trangthai}}" id="trangthai2">Chưa dùng</label>
                </div>
            </div>
      <div class="form-group">
